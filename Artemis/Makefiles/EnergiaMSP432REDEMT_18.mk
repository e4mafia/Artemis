...
#
#
# Last update: 12 Oct 2018 release 10.1.3
...
# With 5.6.1, MSP432 used to be MSP-EXP432P401R, it is now MSP-EXP432P401RR
    ifeq ($(ENERGIA_MSP432_RED_EMT_RELEASE),5.6.1)
    ifeq ($(BOARD_TAG_18),MSP-EXP432P401R)
        BOARD_TAG_18 := MSP-EXP432P401RR
    endif
    endif

# With 5.6.2, MSP432 used to be MSP-EXP432P401RR, it is now MSP-EXP432P401R again!
    ifeq ($(ENERGIA_MSP432_RED_EMT_RELEASE),5.6.2)
    ifeq ($(BOARD_TAG_18),MSP-EXP432P401RR)
        BOARD_TAG_18 := MSP-EXP432P401R
    endif
    endif

# With 5.6.3, MSP432 is still MSP-EXP432P401R!
    ifeq ($(ENERGIA_MSP432_RED_EMT_RELEASE),5.6.3)
    ifeq ($(BOARD_TAG_18),MSP-EXP432P401RR)
        BOARD_TAG_18 := MSP-EXP432P401R
    endif
    endif

# With 5.23.1, MSP432 is still MSP-EXP432P401R!
    ifeq ($(ENERGIA_MSP432_RED_EMT_RELEASE),5.23.1)
    ifeq ($(BOARD_TAG_18),MSP-EXP432P401RR)
        BOARD_TAG_18 := MSP-EXP432P401R
    endif
    endif
...
# ----------------------------------
#
REQUIRED_ENERGIA_MSP432_RED_EMT_RELEASE = 5.6.2
ifeq ($(shell if [[ '$(ENERGIA_MSP432_RED_EMT_RELEASE)' > '$(REQUIRED_ENERGIA_MSP432_RED_EMT_RELEASE)' ]] || [[ '$(ENERGIA_MSP432_RED_EMT_RELEASE)' = '$(REQUIRED_ENERGIA_MSP432_RED_EMT_RELEASE)' ]]; then echo 1 ; else echo 0 ; fi ),0)
$(error Energia MSP432 Red release $(REQUIRED_ENERGIA_MSP432_RED_EMT_RELEASE) or later required, release $(ENERGIA_MSP432_RED_EMT_RELEASE) installed)
endif
