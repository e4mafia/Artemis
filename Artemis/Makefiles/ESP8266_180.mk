...
#
#
# Last update: 12 Oct 2018 release 10.1.2
...
#
PLATFORM         := esp8266
PLATFORM_TAG      = ARDUINO=10805 ARDUINO_ARCH_ESP8266 EMBEDXCODE=$(RELEASE_NOW) ARDUINO_$(BUILD_BOARD) ESP8266 ARDUINO_BOARD=\"$(BUILD_BOARD)\"
...
# Link command
#
EXTRA_COMMAND   = $(CC) -CC -E -P -DVTABLES_IN_FLASH $(HARDWARE_PATH)/tools/sdk/ld/eagle.app.v6.common.ld.h -o $(HARDWARE_PATH)/tools/sdk/ld/eagle.app.v6.common.ld
